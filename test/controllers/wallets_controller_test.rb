...
class WalletsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wallet" do
    assert_difference('Wallet.count') do
      post wallets_url, params: { wallet: { code: @wallet.code, coin_type: @wallet.coin_type, limit: @wallet.limit, network_address: @wallet.network_address } }
    end
  ...
  test "should update wallet" do
    patch wallet_url(@wallet), params: { wallet: { code: @wallet.code, coin_type: @wallet.coin_type, limit: @wallet.limit, network_address: @wallet.network_address } }
