...
class WalletsTest < ApplicationSystemTestCase
  ...
  test "creating a Wallet" do
    ...
    fill_in "Code", with: @wallet.code
    fill_in "Coin Type", with: @wallet.coin_type
    fill_in "Limit", with: @wallet.limit
    fill_in "Network Address", with: @wallet.network_address
